document.addEventListener("DOMContentLoaded", function () {
    ...
    let balanceDetails = document.querySelector(".balance");
    ...
    function updateUI() {
        addAmountDetails.innerHTML = budget.toFixed(2);
        amountDetails.innerHTML = budget.toFixed(2);
        expensesAmountDetails.innerHTML = totalExpenses.toFixed(2);
        expensesDetails.innerHTML = totalExpenses.toFixed(2);
        updateBalance();
        updateExpensesList();
    }
    ...
    function updateBalance() {
        ...
        balanceDetails.innerHTML = balance.toFixed(2);
    }
    ...
    function updateExpensesList() {
        ...
        expensesData.forEach(expense => {
            ...
            li.innerHTML = `${expense.reason}: ${expense.amount.toFixed(2)}`;
